        ...
        <div class="sidebar-scroll">
            <nav>
                <ul class="nav">
                    ...
                    <li><a href="employees.html" class="active"><i class="lnr lnr-employee"></i> <span>Employees</span></a></li>
                                        ...
                                        <tr>
                                            <td>
                                                    <c:out value="${listValue.getId()}"/>
                                                        ...
                                                        <td>
                                                            <c:out value="${listValue.getPhone()}"/>
                                                        </td>
                                                        <td>
                                                            <c:out value="${listValue.getAddress()}"/>
                                                        </td>
                                                        <td>
                                                    <c:out value="${listValue.getPosition()}"/>
                                            </td>
                                        </tr>
