                    ...
                    <div class="panel-body" >
                        ...
                        <div class="form">
                            <div class="form-style-5">
                                <form  id ="CustomerForm" method="POST" commandName="update-Sales-entity" action="/update-sales-row.html">
                                    ...
                                    <fieldset>
                                        ...
                                        <c:forEach  items="${customerList}" var="listValue">
                                            <script>
                                                //alert('${listValue.getName()}');
                                                var select=document.getElementById('pcustomer');
                                                var opt = document.createElement('option');
                                                opt.value = '${listValue.getName()}';
                                                opt.innerHTML = '${listValue.getName()}';
                                                select.appendChild(opt);
                                        ...
                                        <input type="number" id="pquantity" onchange="updateQuantity()" name="quantity" placeholder="Quantity *">
                                        <input type="number" id="ptotal" name="total" placeholder="Amount To Collect *">
                                        <input type="number" name="net" id="pnet" placeholder="AmountReceived *">
                        ...
                        <script>
                            ...
                            function compare()
                            {
                                ...
                                {
                                    //alert("ok");
                                    document.getElementById("pprice").value=parseInt(arguments[1]);
                            ...
                            function updateQuantity()
                            {
                                ...
                                document.getElementById("pnet").value=totalPrice;
                            }
                        </script>
                        <!--Body Ends Here-->
                        <c:forEach  items="${saleslist}" var="listValue">
                            <script>
                                //alert(parseInt('${listValue.getBillNo()}'));
